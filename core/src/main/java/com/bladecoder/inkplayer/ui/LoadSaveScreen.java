...
public class LoadSaveScreen extends ScreenAdapter implements AppScreen {
	...
	public void show() {
		...
		Label title = new Label(loadScreenMode ? ui.translate("ui.load") : ui.translate("ui.save"), skin, "title");
		...
		if (loadScreenMode && sl.size() == 0) {
			Label lbl = new Label(ui.translate("ui.noSavedGames"), skin, "title");
	...
	private Button getSlotButton(String slot) {
		...
		String textLabel = ui.translate("ui.newSlot");
...
*/
	...
	private ClickListener loadClickListener = new ClickListener() {
		...
		public void clicked(InputEvent event, float x, float y) {
			...
			if (world.savedGameExists()) {
				...
				Label l = new Label(ui.translate("ui.override_load"), ui.getSkin(), "ui-dialog");
				l.setWrap(true);
	...
	private ClickListener removeClickListener = new ClickListener() {
		...
		public void clicked(InputEvent event, float x, float y) {
			...
			Label l = new Label(ui.translate("ui.remove"), ui.getSkin(), "ui-dialog");
			l.setWrap(true);
			l.setAlignment(Align.center);
